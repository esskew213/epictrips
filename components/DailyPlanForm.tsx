...
const DailyPlanForm = ({
  ...
  return (
    <div className='bg-slate-200 flex-wrap font-rubik p-6 w-full mx-auto drop-shadow-md flex flex-col items-start'>
      <div className='w-full flex justify-between mb-2'>
        <h4 className='font-rubik inline-block'>
      ...
      <form className='w-full' id={`form-${idx}`}>
        <textarea
          maxLength={2000}
          form={`form-${idx}`}
          className='w-full focus:ring-0 focus:border-yellow-400 font-rubik rounded-lg border-l-8 border-0 border-slate-500'
          rows={4}
          value={notes[plan.id] || ''}
          onChange={(e) => {
